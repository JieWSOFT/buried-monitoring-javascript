...
export interface Options {
  ...
  /**
   * Specifies whether this SDK should send events to BM.
   * Defaults to true.
   */
  enabled?: boolean;

  /**
   * The Dsn used to connect to BM and identify the project. If omitted, the
   * SDK will not send any data to BM.
   */
  dsn?: string;
  ...
  /**
   * A pattern for error messages which should not be sent to BM.
   * By default, all errors will be sent.
   */
  ignoreErrors?: Array<string | RegExp>;

  /**
   * Transport object that should be used to send events to BM
   */
   ...
   * that accepts BM envelopes for forwarding. This can be used to force data
   ...
   * this value to allow BM to resolve the correct source maps when
   * processing events.
   */
  release?: string;
   ...
   * the event before it is sent to BM.
   *
