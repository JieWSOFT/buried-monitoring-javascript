...
export interface Hub {
  ...
  /**
   * Captures an exception event and sends it to BM.
   *
  ...
  /**
   * Captures a message event and sends it to BM.
   *
   * @param message The message to send to BM.
  ...
  /**
   * Captures a manually created event and sends it to BM.
   *
   ...
   * e.g.: Reporting issues to your own BM when running in your component while still using the users configuration.
   */
   ...
   * finished child spans will be sent to BM.
   *
  ...
  /**
   * Ends the session that lives on the current scope and sends it to BM
   */
  endSession(): void;

  /**
   * Sends the current session on the scope to BM
